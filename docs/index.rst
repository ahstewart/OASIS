...
It was developed for use in UC Santa Barbara's Optical SETI program (`project homepage <https://www.deepspace.ucsb.edu/projects/implications-of-directed-energy-for-seti>`_), but can be deployed in any application involving anomaly detection in astronomical data. 
